...
{
	// Token: 0x02006CF6 RID: 27894
	public class LevelConditionCheckExploreSkill : LevelConditionBase
	{
		// Token: 0x06044422 RID: 279586 RVA: 0x011BB114 File Offset: 0x011B9314
		[NullableContext(1)]
		public override bool Check(Condition inConditionInfo, [Nullable(2)] AActor inTrigger, params object[] eventArgs)
		{
			...
			int num = int.Parse(inConditionInfo.GetLimitParams("探索技能Id"));
			if (num == 0)
			{
				...
				defaultInterpolatedStringHandler.AppendLiteral("的探索技能Id应该是数字");
			...
			return num == ModelBase<RouletteModel>.Instance.CurrentExploreSkillId;
		}
	}
}
