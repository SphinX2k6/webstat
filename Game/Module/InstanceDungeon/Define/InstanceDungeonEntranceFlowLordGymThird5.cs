...
namespace CSharpScript.Game.Module.InstanceDungeon.Define
{
	...
	public class InstanceDungeonEntranceFlowLordGymThird5 : InstanceDungeonEntranceFlowBase
	{
		// Token: 0x0603BA24 RID: 244260 RVA: 0x00F1C138 File Offset: 0x00F1A338
		protected override void OnCreate()
		{
			base.AddStep(delegate
			{
				if (ControllerBase<LordGymController>.Instance.IsInLordGymDungeon())
				{
					...
					Singleton<UiManager>.Instance.OpenView(EUiViewName.LordGymThird5DifficultySelectView, param, null);
					return;
				}
				if (ModelBase<LordGymModel>.Instance.SkipBossSelectInFlow)
				{
					...
					Singleton<UiManager>.Instance.OpenView(EUiViewName.LordGymThird5DifficultySelectView, param2, null);
					return;
				}
				...
				Singleton<UiManager>.Instance.OpenView(EUiViewName.LordGymThird5LittleLoadingView, param3, null);
			});
			base.AddStep(delegate
			{
			...
			base.AddStep(delegate
			{
				...
				ControllerBase<InstanceDungeonEntranceController>.Instance.EnterInstanceDungeon().ContinueWith(delegate(bool bSuccess)
				{
